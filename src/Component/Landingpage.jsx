...
>
  <video
    ...
    playsInline
  >
    <source src={vet1} type="video/mp4" />
    Your browser does not support the video tag.
      ...
      >
        ...
        <a
  href="/Contact"
  className="mt-8 inline-block text-lg font-medium px-8 py-4 rounded-lg shadow-lg bg-[#5245c9] text-white transition-all duration-300 hover:bg-orange-600 hover:scale-105 hover:shadow-xl active:scale-95"
>
  Consult Now →
</a>
      </motion.div>
