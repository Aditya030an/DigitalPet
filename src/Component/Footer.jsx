      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            ...
            />
            <h2 className="text-3xl font-extrabold mt-3 font-[lato] text-gray-900">
              Digitalpetclinic.com
            </h2>
            <p className="text-gray-700 font-[lato] text-sm">
              A Virtual Veterinary Clinic{" "}
            </p>
            <p className="text-gray-700 font-[lato] mt-4 leading-relaxed">
              We help pet parents & their beloved companions—whether fur babies
              or exotic pets—enjoy a happy, healthy journey from infancy to
              their golden years.
            </p>
          ...
          <motion.div
            ...
            whileHover={{ scale: 1.02 }}
          >
            <h3 className="text-xl text-gray-900 font-[lato] font-semibold mb-4">
              Our Services
            </h3>
            ...
            >
              <a
                href="/Terms"
                className="text-gray-600 font-[lato] text-lg hover:underline whitespace-nowrap"
              >
                Terms & Conditions
              </a>
              <a
          ...
          {/* Contact Section */}
          <motion.div
            className="text-center  font-[lato] md:text-left"
            whileHover={{ scale: 1.02 }}
          >
            <h3 className="text-xl font-[lato] text-gray-900 font-semibold mb-4">
              Contact Us
            </h3>
            <ul className="space-y-2 font-[lato] text-gray-800">
              <motion.li whileHover={{ x: 5, color: "#333" }}>
                <a
                  href="mailto:vetonlineconsults@gmail.com"
                  className="hover:text-gray-900 font-[lato] transition"
                >
                ...
                <div className="flex flex-col space-y-1">
                  <div className="flex flex-col">
                    ...
                    <a
                      ...
                      className="text-gray-700 font-[lato] hover:text-gray-900 transition duration-300"
                    >
                      +91 94240 94362
                    </a>
                    {/* Instagram Link */}
                  ...
                  <div className="flex flex-col">
                    <span className="text-gray-900 font-[lato] font-semibold">
                      Dr. Vishal
                    </span>
                    <a
                      href="tel:+918200600163"
                      className="text-gray-700 font-[lato] hover:text-gray-900 transition duration-300"
                    >
                      +91 82006 00163
                    </a>
        ...
        >
          © {new Date().getFullYear()} Digitalpetclinic.com - All Rights
          Reserved
        </motion.div>
      </div>
    </footer>
